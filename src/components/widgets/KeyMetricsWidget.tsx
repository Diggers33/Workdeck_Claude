...
export function KeyMetricsWidget() {
  ...
  return (
    ...
    >
      ...
      >
        <BarChart3 style={{ width: '20px', height: '20px', color: '#0066FF' }} />
        <h3
          style={{
            fontSize: '16px',
            fontWeight: 600,
            ...
            {metrics.map((metric, index) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    <Icon style={{ width: '20px', height: '20px', color: metric.iconColor }} />
                    ...
                    {metric.trend !== undefined && (
                      ...
                      >
                        {metric.trend > 0 ? (
                          <TrendingUp style={{ width: '10px', height: '10px', color: 'white' }} />
                        ) : (
                          <TrendingDown style={{ width: '10px', height: '10px', color: 'white' }} />
                        )}
                      </div>
                    )}
                  </div>
