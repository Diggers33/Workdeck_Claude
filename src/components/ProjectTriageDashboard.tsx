...
export function ProjectTriageDashboard() {
  ...
  return (
    <div style={{ width: '1200px', minHeight: '1400px', background: '#FFFFFF', margin: '0 auto' }}>
      {/* HEADER */}
      <div style={{ padding: '32px 40px 0', height: '100px' }}>
        ...
        <div className="flex items-center gap-2">
          {[
            ...
            >
              ...
              <span
                style={{
                  background: activeFilter === filter.label ? 'rgba(255,255,255,0.2)' : '#F3F4F6',
                  color: activeFilter === filter.label ? 'white' : '#6B7280',
                  padding: '2px 8px',
                  borderRadius: '10px',
                  fontSize: '12px',
      ...
      <div style={{ marginTop: '32px' }}>
        ...
        >
          <div style={{ fontSize: '11px', fontWeight: 500, color: '#6B7280', letterSpacing: '0.5px' }}>ALERT</div>
          <div style={{ fontSize: '11px', fontWeight: 500, color: '#6B7280', letterSpacing: '0.5px' }}>PROJECT CONTEXT</div>
          <div style={{ fontSize: '11px', fontWeight: 500, color: '#6B7280', letterSpacing: '0.5px' }}>TIMELINE & PROGRESS</div>
          <div style={{ fontSize: '11px', fontWeight: 500, color: '#6B7280', letterSpacing: '0.5px' }}>NEXT ACTIVITY</div>
          <div style={{ fontSize: '11px', fontWeight: 500, color: '#6B7280', letterSpacing: '0.5px', textAlign: 'right' }}>ACTION</div>
        </div>
        ...
        {projects.map((project, idx) => (
          ...
          >
            ...
            <div className="flex flex-col items-center justify-center" style={{ gap: '8px' }}>
              ...
              <div
                style={{
                  ...
                  animation: project.pulse ? 'pulse 2s infinite' : 'none',
                  boxShadow: project.pulse ? `0 0 8px ${project.priorityColor}50` : 'none'
                }}
              />
            ...
            <div className="flex flex-col" style={{ gap: '4px' }}>
              ...
              <div style={{ fontSize: '13px', fontWeight: 600, color: project.activityColor }}>
                <span style={{ marginRight: '4px' }}>{project.activityIcon}</span>
                {project.nextActivityTime}
              </div>
            </div>
